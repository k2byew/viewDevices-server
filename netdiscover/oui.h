/*
 * Organizationally Unique Identifier list at date 08-Sep-2015
...
struct oui oui_table[] = {
   ...
   { "6CE3B6", "Nera Telecommunciations Ltd" },
   { "942CB3", "HUMAX Co., Ltd." },
   ...
   { "EC5F23", "Kimascend Electronics and Technology Ltd." },
   ...
   { "A0F895", "Tinno Mobile Technology Corp" },
   { "949F3E", "Sonos, Inc." },
